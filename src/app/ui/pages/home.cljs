...
(defnc HomeRenderer [_]
  ($ HomeWrapper
     ...
     (d/div {:class "bg-fixed bg-black text-white"}
            ...
            (d/div {:class "text-center my-48"}
                   (d/h1 {:class "uppercase font-light text-3xl"} "Currently in development"))
            (d/div {:class "mx-80"}
